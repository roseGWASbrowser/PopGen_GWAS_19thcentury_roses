...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/E2hexenal_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/E2hexenal_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/E2hexenal_gwas_results")
#gwasres=read.table("E2hexenal_scores.txt.withoutchrNA.sed",h=T)
#trait="E2hexenal"
#label_legend="GWAS E2hexenal (2017)"
#label_legend="GWAS E2hexenal (2018)"
#label_legend="GWAS E2hexenal (2 years)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/E2hexenal_binary1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/E2hexenal_binary1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/E2hexenal_binary1_gwas_results")
#gwasres=read.table("E2hexenal_binary1_scores.txt.withoutchrNA.sed",h=T)
#trait="E2hexenal_binary1"
#label_legend="GWAS E2hexenal (binary 2017 - cutoff: 1)"
#label_legend="GWAS E2hexenal (binary 2018 - cutoff: 1)"
#label_legend="GWAS E2hexenal (binary 2 years - cutoff: 1)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/E2hexenal_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/E2hexenal_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/E2hexenal_binary0p1_gwas_results")
#gwasres=read.table("E2hexenal_binary0p1_scores.txt.withoutchrNA.sed",h=T)
#trait="E2hexenal_binary0p1"
#label_legend="GWAS E2hexenal (binary 2017 - cutoff: 0.1)"
#label_legend="GWAS E2hexenal (binary 2018 - cutoff: 0.1)"
#label_legend="GWAS E2hexenal (binary 2 years - cutoff: 0.1)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/E2hexenal_binaryPresAbs_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/E2hexenal_binaryPresAbs_gwas_results")
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/E2hexenal_binaryPresAbs_gwas_results")
gwasres=read.table("E2hexenal_binaryPresAbs_scores.txt.withoutchrNA.sed",h=T)
trait="E2hexenal_binaryPresAbs"
#label_legend="GWAS E2hexenal (binary 2017 - cutoff: 0)"
#label_legend="GWAS E2hexenal (binary 2018 - cutoff: 0)"
label_legend="GWAS E2hexenal (binary 2 years - cutoff: 0)"
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # QTL 95%
  # 2014
  circos.rect(sector.index=4,xleft=19132510,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=39209552,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # lightcoral = 2017
  circos.rect(sector.index=5,xleft=5279163,ybottom=max(dataset$Prop_Win_Total)*1.71,xright=10262374,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=5,xleft=876757,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=5286233,ytop=max(dataset$Prop_Win_Total)*1.7,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=6,xleft=1518964,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=7670250,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
 
  # 2015
  circos.rect(sector.index=1,xleft=8070468,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=50317157,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=4,xleft=19132510,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=30431347,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=5,xleft=5279163,ybottom=max(dataset$Prop_Win_Total)*1.51,xright=8203893,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=5,xleft=876757,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=4536435,ytop=max(dataset$Prop_Win_Total)*1.5,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=6,xleft=222596,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=65745018,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  
  # 2017
  circos.rect(sector.index=1,xleft=14426653,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=47955919,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=3,xleft=41401190,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=46440369,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=4,xleft=19132510,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=28730085,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=5,xleft=5279163,ybottom=max(dataset$Prop_Win_Total)*1.31,xright=10751679,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=5,xleft=876757,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=17333631,ytop=max(dataset$Prop_Win_Total)*1.3,lwd=0.01,lty=1,col="#FFA500") #  = 2019
