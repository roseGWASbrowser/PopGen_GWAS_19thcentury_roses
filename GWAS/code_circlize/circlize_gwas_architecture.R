...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/phenoflorhige/Plant_Type_ArbustifOuAutre_gwas_results/")
#gwasres=read.table("Plant_Type_ArbustifOuAutre_scores.txt.withoutchrNA.sed",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
#trait="Plant_Type_ArbustifOuAutre"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/phenoflorhige/Plant_Type_BuissonnantOuAutre_gwas_results/")
#gwasres=read.table("Plant_Type_BuissonnantOuAutre_scores.txt.withoutchrNA.sed",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
#trait="Plant_Type_BuissonnantOuAutre"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/phenoflorhige/Shape_2012_gwas_results/")
#gwasres=read.table("Shape_2012_scores.txt.withoutchrNA.sed",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
#trait="Shape_2012"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/phenoflorhige/Shape_2013_gwas_results/")
#gwasres=read.table("Shape_2013_scores.txt.withoutchrNA.sed",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
#trait="Shape_2013"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/phenoflorhige/Shape_2014_gwas_results/")
#gwasres=read.table("Shape_2014_scores.txt.withoutchrNA.sed",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
#trait="Shape_2014"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/phenoflorhige/Shape_across_year_gwas_results/")
#gwasres=read.table("Shape_across_year_scores.txt.withoutchrNA.sed",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
#trait="Shape_across_year"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/phenoflorhige/Shape2014_ConiqueOuNon_gwas_results/")
#gwasres=read.table("Shape2014_ConiqueOuNon_scores.txt.withoutchrNA.sed",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
#trait="Shape2014_ConiqueOuNon"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/phenoflorhige/Shape2014_CylindriqueOuNon_gwas_results/")
#gwasres=read.table("Shape2014_CylindriqueOuNon_scores.txt.withoutchrNA.sed",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
#trait="Shape2014_CylindriqueOuNon"

setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/phenoflorhige/Shape2014_SpheriqueOuNon_gwas_results/")
gwasres=read.table("Shape2014_SpheriqueOuNon_scores.txt.withoutchrNA.sed",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
trait="Shape2014_SpheriqueOuNon"
