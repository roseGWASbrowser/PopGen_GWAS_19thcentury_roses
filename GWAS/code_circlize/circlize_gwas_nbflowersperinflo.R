...
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/phenoflorhige/nb_flowers_per_inflorescence_gwas_results/")
gwasres=read.table("nb_flowers_per_inflorescence_scores.txt.withoutchrNA.sed",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
trait="nb_flowers_per_inflorescence"
