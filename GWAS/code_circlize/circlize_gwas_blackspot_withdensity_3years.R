...
gwasres1=read.table("./TN2014_gwas_results/TN2014_scores.sed.withoutchrNA",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
trait1="TN2014"
gwasres2=read.table("./TN2015_gwas_results/TN2015_scores.sed.withoutchrNA",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
trait2="TN2015"
gwasres3=read.table("./TN2016_gwas_results/TN2016_scores.sed.withoutchrNA",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
trait3="TN2016"
