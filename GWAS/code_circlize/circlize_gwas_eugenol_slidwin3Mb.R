...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/eugenol_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/eugenol_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/eugenol_gwas_results")
#gwasres=read.table("eugenol_scores.txt.withoutchrNA.sed",h=T)
#trait="eugenol"
#label_legend="GWAS Eugenol (2017)"
#label_legend="GWAS Eugenol (2018)"
#label_legend="GWAS Eugenol (2 years)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/eugenol_binaryPresAbs_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/eugenol_binaryPresAbs_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/eugenol_binaryPresAbs_gwas_results")
#gwasres=read.table("eugenol_binaryPresAbs_scores.txt.withoutchrNA.sed",h=T)
#trait="eugenol_binaryPresAbs"
#label_legend="GWAS Eugenol (binary 2017 - cutoff: 0)"
#label_legend="GWAS Eugenol (binary 2018 - cutoff: 0)"
#label_legend="GWAS Eugenol (binary 2 years - cutoff: 0)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/eugenol_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/eugenol_binary0p1_gwas_results")
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/eugenol_binary0p1_gwas_results")
gwasres=read.table("eugenol_binary0p1_scores.txt.withoutchrNA.sed",h=T)
trait="eugenol_binary0p1"
#label_legend="GWAS Eugenol (binary 2017 - cutoff: 0.1)"
#label_legend="GWAS Eugenol (binary 2018 - cutoff: 0.1)"
label_legend="GWAS Eugenol (binary 2 years - cutoff: 0.1)"
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # QTL 95%
  # 2014
  circos.rect(sector.index=2,xleft=219594,ybottom=max(dataset$Prop_Win_Total)*1.71,xright=38563162,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # lightcoral = 2017
  circos.rect(sector.index=2,xleft=956943,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=74254775,ytop=max(dataset$Prop_Win_Total)*1.7,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  ...
  circos.rect(sector.index=2,xleft=1939385,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=74527841,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=4,xleft=712806,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=58329595,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=5,xleft=10955086,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=85719826,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  
  # 2017
  circos.rect(sector.index=1,xleft=43851595,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=61139146,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=2,xleft=21085250,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=62032350,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=3,xleft=23585908,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=40178420,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=6,xleft=54247606,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=59391958,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
