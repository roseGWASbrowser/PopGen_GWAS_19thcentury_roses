...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/geraniol_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/geraniol_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/geraniol_gwas_results")
#gwasres=read.table("geraniol_scores.txt.withoutchrNA.sed",h=T)
#trait="geraniol"
#label_legend="GWAS Geraniol (2017)"
#label_legend="GWAS Geraniol (2018)"
#label_legend="GWAS Geraniol (2 years)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/geraniol_binary10_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/geraniol_binary10_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/geraniol_binary10_gwas_results")
#gwasres=read.table("geraniol_binary10_scores.txt.withoutchrNA.sed",h=T)
#trait="geraniol_binary10"
#label_legend="GWAS Geraniol (binary 2017 - cutoff: 10)"
#label_legend="GWAS Geraniol (binary 2018 - cutoff: 10)"
#label_legend="GWAS Geraniol (binary 2 years - cutoff: 10)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/geraniol_binary50_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/geraniol_binary50_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/geraniol_binary50_gwas_results")
#gwasres=read.table("geraniol_binary50_scores.txt.withoutchrNA.sed",h=T)
#trait="geraniol_binary50"
#label_legend="GWAS Geraniol (binary 2017 - cutoff: 50)"
#label_legend="GWAS Geraniol (binary 2018 - cutoff: 50)"
#label_legend="GWAS Geraniol (binary 2 years - cutoff: 50)"
...
#gwasres=read.table("geraniol_binary50_scores.txt.withoutchrNA.sed",h=T)
#trait="geraniol_binary50"
#label_legend="GWAS Monoterpene alcohol (binary 2017 - cutoff: 50)"
#label_legend="GWAS Monoterpene alcohol (binary 2018 - cutoff: 50)"
#label_legend="GWAS Monoterpene alcohol (binary 2 years - cutoff: 50)"
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # QTL 95%
  # 2014
  circos.rect(sector.index=2,xleft=1203089,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=38563162,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # lightcoral = 2017
  circos.rect(sector.index=4,xleft=19132510,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=51324600,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=5,xleft=74522960,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=83806257,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  
  # 2015
  circos.rect(sector.index=2,xleft=556808,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=38563162,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  ...
  circos.rect(sector.index=5,xleft=65918210,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=83806257,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  
  # 2017
  circos.rect(sector.index=2,xleft=6911033,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=37201365,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=4,xleft=13281656,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=39209552,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
