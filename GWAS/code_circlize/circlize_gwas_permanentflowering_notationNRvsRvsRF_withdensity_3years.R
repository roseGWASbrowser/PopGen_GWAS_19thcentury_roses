...
trait="codenumremontee"
gwasres1=read.table("./A1/codenumremonteeYear1_gwas_results/codenumremonteeYear1_scores.sed.withoutchrNA",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
trait1=paste0(trait,"Year1")
gwasres2=read.table("./A2/codenumremonteeYear2_gwas_results/codenumremonteeYear2_scores.sed.withoutchrNA",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
trait2=paste0(trait,"Year2")
gwasres3=read.table("./A3/codenumremonteeYear3_gwas_results/codenumremonteeYear3_scores.sed.withoutchrNA",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
trait3=paste0(trait,"Year3")
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  circos.segments(sector.index=4,x0=53257785,y0=0,x1=53257785,y1=max(dataset1$Prop_Win_Total),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=3,x0=46602666,y0=0,x1=46602666,y1=max(dataset1$Prop_Win_Total),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=6,x0=44936940,y0=0,x1=44936940,y1=max(dataset1$Prop_Win_Total),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=1,x0=60629756,y0=0,x1=60629756,y1=max(dataset1$Prop_Win_Total),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=7,x0=1119812,y0=0,x1=1119812,y1=max(dataset1$Prop_Win_Total),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=5,x0=36547517,y0=0,x1=36547517,y1=max(dataset1$Prop_Win_Total),lwd=0.3,lty=1,col="forestgreen")
 ...
 # density SNP
  ...
  # other suggestion Fabrice 08/07/22
  circos.segments(sector.index=4,x0=53257785,y0=0,x1=53257785,y1=max(-log10(gwasres1[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=3,x0=46602666,y0=0,x1=46602666,y1=max(-log10(gwasres1[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=6,x0=44936940,y0=0,x1=44936940,y1=max(-log10(gwasres1[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=1,x0=60629756,y0=0,x1=60629756,y1=max(-log10(gwasres1[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=7,x0=1119812,y0=0,x1=1119812,y1=max(-log10(gwasres1[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=5,x0=36547517,y0=0,x1=36547517,y1=max(-log10(gwasres1[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  ...
  circos.text(sector.index=4, 53257785, max(-log10(gwasres1[[columntoplot]]),na.rm=TRUE)*0.82, "FT1",cex=0.75,col="forestgreen") 
  circos.text(sector.index=3, 46602666, max(-log10(gwasres1[[columntoplot]]),na.rm=TRUE)*0.82, "FT3",cex=0.75,col="forestgreen") 
  circos.text(sector.index=6, 44936940, max(-log10(gwasres1[[columntoplot]]),na.rm=TRUE)*0.9, "BFT",cex=0.75,col="forestgreen") 
  circos.text(sector.index=1, 60629756, max(-log10(gwasres1[[columntoplot]]),na.rm=TRUE), "BFT",cex=0.75,col="forestgreen") 
  circos.text(sector.index=7, 1119812, max(-log10(gwasres1[[columntoplot]]),na.rm=TRUE)*0.9, "MFT",cex=0.75,col="forestgreen") 
  circos.text(sector.index=5, 36547517, max(-log10(gwasres1[[columntoplot]]),na.rm=TRUE), "ATC",cex=0.75,col="forestgreen") 
  ...
  # other suggestion Fabrice 08/07/22
  circos.segments(sector.index=4,x0=53257785,y0=0,x1=53257785,y1=max(-log10(gwasres2[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=3,x0=46602666,y0=0,x1=46602666,y1=max(-log10(gwasres2[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=6,x0=44936940,y0=0,x1=44936940,y1=max(-log10(gwasres2[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=1,x0=60629756,y0=0,x1=60629756,y1=max(-log10(gwasres2[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=7,x0=1119812,y0=0,x1=1119812,y1=max(-log10(gwasres2[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=5,x0=36547517,y0=0,x1=36547517,y1=max(-log10(gwasres2[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  ...
  # other suggestion Fabrice 08/07/22
  circos.segments(sector.index=4,x0=53257785,y0=0,x1=53257785,y1=max(-log10(gwasres3[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=3,x0=46602666,y0=0,x1=46602666,y1=max(-log10(gwasres3[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=6,x0=44936940,y0=0,x1=44936940,y1=max(-log10(gwasres3[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=1,x0=60629756,y0=0,x1=60629756,y1=max(-log10(gwasres3[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=7,x0=1119812,y0=0,x1=1119812,y1=max(-log10(gwasres3[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=5,x0=36547517,y0=0,x1=36547517,y1=max(-log10(gwasres3[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  ...
  # other suggestion Fabrice 08/07/22
  circos.segments(sector.index=4,x0=53257785,y0=0,x1=53257785,y1=max(dataset1$PropSNPWinPvalueInf01,dataset2$PropSNPWinPvalueInf01,dataset3$PropSNPWinPvalueInf01,na.rm=TRUE),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=3,x0=46602666,y0=0,x1=46602666,y1=max(dataset1$PropSNPWinPvalueInf01,dataset2$PropSNPWinPvalueInf01,dataset3$PropSNPWinPvalueInf01,na.rm=TRUE),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=6,x0=44936940,y0=0,x1=44936940,y1=max(dataset1$PropSNPWinPvalueInf01,dataset2$PropSNPWinPvalueInf01,dataset3$PropSNPWinPvalueInf01,na.rm=TRUE),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=1,x0=60629756,y0=0,x1=60629756,y1=max(dataset1$PropSNPWinPvalueInf01,dataset2$PropSNPWinPvalueInf01,dataset3$PropSNPWinPvalueInf01,na.rm=TRUE),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=7,x0=1119812,y0=0,x1=1119812,y1=max(dataset1$PropSNPWinPvalueInf01,dataset2$PropSNPWinPvalueInf01,dataset3$PropSNPWinPvalueInf01,na.rm=TRUE),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=5,x0=36547517,y0=0,x1=36547517,y1=max(dataset1$PropSNPWinPvalueInf01,dataset2$PropSNPWinPvalueInf01,dataset3$PropSNPWinPvalueInf01,na.rm=TRUE),lwd=0.3,lty=1,col="forestgreen")
