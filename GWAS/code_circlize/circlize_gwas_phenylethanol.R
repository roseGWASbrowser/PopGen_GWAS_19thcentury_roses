...
# annotations
  for (line in 1:nrow(gene)){
    circos.segments(sector.index=as.character(gene[line,4]),x0=gene[line,8],y0=0,x1=gene[line,8],y1=max(dataset$Prop_Win_Total),col=ifelse(gene[line,1]=="PE","purple","lightcyan2"),lwd=ifelse(gene[line,1]=="PE",2,1))
  }
  ...
  # annotations
  #for (line in 1:nrow(gene)){
  #  circos.segments(sector.index=as.character(gene$V4[line]),x0=gene$V8[line],y0=0,x1=gene$V8[line],y1=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE),col=ifelse(gene$V1[line]=="PE","purple","grey"),lwd=ifelse(gene$V1[line]=="PE",2,1))
  #}
  ...
  for (line in 1:nrow(gene)){
    circos.text(sector.index=as.character(gene$V4[line]),x=gene$V8[line],y=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*.85,labels=paste(gene$V2[line],"(",gene$V3[line],")",sep=""),col=ifelse(gene$V1[line]=="PE","purple","lightcyan2"),cex=ifelse(gene$V1[line]=="PE",0.6,0.5),facing = "reverse.clockwise")
  }
  ...
  #
  for (line in 1:nrow(gene)){
    circos.segments(sector.index=as.character(gene$V4[line]),x0=gene$V8[line],y0=0,x1=gene$V8[line],y1=max(dataset$PropSNPWinPvalueInf05,na.rm=TRUE),col=ifelse(gene$V1[line]=="PE","purple","lightcyan2"),lwd=ifelse(gene$V1[line]=="PE",2,1))
  }
  ...
  #
  for (line in 1:nrow(gene)){
    circos.segments(sector.index=as.character(gene$V4[line]),x0=gene$V8[line],y0=0,x1=gene$V8[line],y1=max(dataset$PropSNPWinPvalueInf01,na.rm=TRUE),col=ifelse(gene$V1[line]=="PE","purple","lightcyan2"),lwd=ifelse(gene$V1[line]=="PE",2,1))
  }
  ...
  #
  for (line in 1:nrow(gene)){
    circos.segments(sector.index=as.character(gene$V4[line]),x0=gene$V8[line],y0=0,x1=gene$V8[line],y1=max(dataset$PropSNPWinPvalueInf001,na.rm=TRUE),col=ifelse(gene$V1[line]=="PE","purple","lightcyan2"),lwd=ifelse(gene$V1[line]=="PE",2,1))
  }
