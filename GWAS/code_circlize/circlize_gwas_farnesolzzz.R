...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/EEfarnesol_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/EEfarnesol_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/EEfarnesol_gwas_results")
#gwasres=read.table("EEfarnesol_scores.txt.withoutchrNA.sed",h=T)
#trait="EEfarnesol"
#label_legend="GWAS EE Farnesol (2017)"
#label_legend="GWAS EE Farnesol (2018)"
#label_legend="GWAS EE Farnesol (2 years)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/EEfarnesol_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/EEfarnesol_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/EEfarnesol_binary0p1_gwas_results")
#gwasres=read.table("EEfarnesol_binary0p1_scores.txt.withoutchrNA.sed",h=T)
#trait="EEfarnesol_binary0p1"
#label_legend="GWAS EE Farnesol (binary 2017 - cutoff: 0.1)"
#label_legend="GWAS EE Farnesol (binary 2018 - cutoff: 0.1)"
#label_legend="GWAS EE Farnesol (binary 2018 - cutoff: 0.1)"
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # QTL 95%
  # 2014
  circos.rect(sector.index=1,xleft=452535,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=33163492,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # lightcoral = 2017
  circos.rect(sector.index=3,xleft=18708317,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=34607514,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=4,xleft=55803663,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=58329595,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=7,xleft=28966373,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=33102847,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  
  # 2015
  circos.rect(sector.index=1,xleft=33163492,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=47360932,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=5,xleft=137964,ybottom=max(dataset$Prop_Win_Total)*1.51,xright=68715373,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=5,xleft=17772634,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=29812735,ytop=max(dataset$Prop_Win_Total)*1.5,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=7,xleft=4722419,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=18944562,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  
  # 2017
  circos.rect(sector.index=5,xleft=1159318,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=34729333,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=4,xleft=712806,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=44188764,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=7,xleft=4722419,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=28966373,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  ...
  # annotations
  circos.segments(sector.index=7,41385360,y0=0,x1=41385360,y1=max(dataset$Prop_Win_Total),lwd=2,lty=1,col="purple")
  ...
  # annotation roAP2
  circos.segments(sector.index=7,x0=41385360,y0=0,x1=41385360,y1=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*0.8,lwd=2,lty=1,col="purple")

  circos.text(sector.index=7, 41385360, max(-log10(gwasres[[columntoplot]]),na.rm=TRUE), "NUDIX1-2",cex=0.75,col="purple")
  ...
  #
  circos.segments(sector.index=7,x0=41385360,y0=0,x1=41385360,y1=max(dataset$PropSNPWinPvalueInf05,na.rm=TRUE),lwd=2,lty=1,col="purple")
  ...
  #
  circos.segments(sector.index=7,x0=41385360,y0=0,x1=41385360,y1=max(dataset$PropSNPWinPvalueInf01,na.rm=TRUE),lwd=2,lty=1,col="purple")
  ...
  #
  circos.segments(sector.index=7, x0=41385360,y0=0,x1=41385360,y1=max(dataset$PropSNPWinPvalueInf001,na.rm=TRUE),lwd=2,lty=1,col="purple")
