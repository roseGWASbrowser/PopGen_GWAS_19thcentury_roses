...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/geranylacetate_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/geranylacetate_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/geranylacetate_gwas_results")
#gwasres=read.table("geranylacetate_scores.txt.withoutchrNA.sed",h=T)
#trait="geranylacetate"
#label_legend="GWAS geranylacetate (2017)"
#label_legend="GWAS geranylacetate (2018)"
#label_legend="GWAS geranylacetate (All)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/geranylacetate_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/geranylacetate_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/geranylacetate_binary0p1_gwas_results")
#gwasres=read.table("geranylacetate_binary0p1_scores.txt.withoutchrNA.sed",h=T)
#trait="geranylacetate_binary0p1"
#label_legend="GWAS geranylacetate (binary 2017 - cutoff: 0.1)"
#label_legend="GWAS geranylacetate (binary 2018 - cutoff: 0.1)"
#label_legend="GWAS geranylacetate (binary All - cutoff: 0.1)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/geranylacetate_binary5_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/geranylacetate_binary5_gwas_results")
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/geranylacetate_binary5_gwas_results")
gwasres=read.table("geranylacetate_binary5_scores.txt.withoutchrNA.sed",h=T)
trait="geranylacetate_binary5"
#label_legend="GWAS geranylacetate (binary 2017 - cutoff: 5)"
#label_legend="GWAS geranylacetate (binary 2018 - cutoff: 5)"
label_legend="GWAS geranylacetate (binary All - cutoff: 5)"
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # QTL 95%
# 2014
  circos.rect(sector.index=2,xleft=5307889,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=47013288,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=4,xleft=33320924,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=58643863,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # lightcoral = 2017

  # 2015
  circos.rect(sector.index=1,xleft=14426653,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=33163492,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=2,xleft=5307889,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=43086300,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019

  # 2017
  circos.rect(sector.index=1,xleft=452535,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=58038560,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=2,xleft=5307889,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=47013288,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=5,xleft=6609403,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=56683826,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
