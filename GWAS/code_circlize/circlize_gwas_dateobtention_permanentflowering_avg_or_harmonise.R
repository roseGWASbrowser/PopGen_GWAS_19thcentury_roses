...
gwasres=read.table("./permanentflowering/codenumremonteeHarmonise3years_gwas_results/codenumremonteeHarmonise3years_scores.sed.withoutchrNA",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # roQSN region
  circos.rect(sector.index=3,xleft=28500000,ybottom=max(dataset$Prop_Win_Total)*-0.1,xright=33000000,ytop=max(dataset$Prop_Win_Total)*0.9,lwd=0.01,lty=1,col="pink")
...
# other suggestion Fabrice 08/07/22
  circos.segments(sector.index=4,x0=53257785,y0=0,x1=53257785,y1=max(dataset$Prop_Win_Total)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=3,x0=46602666,y0=0,x1=46602666,y1=max(dataset$Prop_Win_Total)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=6,x0=44936940,y0=0,x1=44936940,y1=max(dataset$Prop_Win_Total)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=1,x0=60629756,y0=0,x1=60629756,y1=max(dataset$Prop_Win_Total)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=7,x0=1119812,y0=0,x1=1119812,y1=max(dataset$Prop_Win_Total)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=5,x0=36547517,y0=0,x1=36547517,y1=max(dataset$Prop_Win_Total)*0.8,lwd=0.3,lty=1,col="forestgreen")
 ...
 # density SNP
  ...
  # roQSN region
  circos.rect(sector.index=3,xleft=28500000,ybottom=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*-0.1,xright=33000000,ytop=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*1.1,lwd=0.01,lty=1,col="pink")
  circos.text(sector.index=3, 30750000, max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*0.93, "roKSN\nregion",cex=0.65,col="purple")
  ...
  # suggestion Fabrice 08/07/22
  circos.text(sector.index=4, 53257785, max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*0.82, "FT1",cex=0.75,col="forestgreen") 
  circos.text(sector.index=3, 46602666, max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*0.82, "FT3",cex=0.75,col="forestgreen") 
  circos.text(sector.index=6, 44936940, max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*0.9, "BFT",cex=0.75,col="forestgreen") 
  circos.text(sector.index=1, 60629756, max(-log10(gwasres[[columntoplot]]),na.rm=TRUE), "BFT",cex=0.75,col="forestgreen") 
  circos.text(sector.index=7, 1119812, max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*0.9, "MFT",cex=0.75,col="forestgreen") 
  circos.text(sector.index=5, 36547517, max(-log10(gwasres[[columntoplot]]),na.rm=TRUE), "ATC",cex=0.75,col="forestgreen") 
  ...
  # other suggestion Fabrice 08/07/22
  circos.segments(sector.index=4,x0=53257785,y0=0,x1=53257785,y1=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=3,x0=46602666,y0=0,x1=46602666,y1=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=6,x0=44936940,y0=0,x1=44936940,y1=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=1,x0=60629756,y0=0,x1=60629756,y1=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=7,x0=1119812,y0=0,x1=1119812,y1=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=5,x0=36547517,y0=0,x1=36547517,y1=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*0.8,lwd=0.3,lty=1,col="forestgreen")
  ...
  # roQSN region
  circos.rect(sector.index=3,xleft=28500000,ybottom=max(dataset$PropSNPWinPvalueInf05,na.rm=TRUE)*-0.1,xright=33000000,ytop=max(dataset$PropSNPWinPvalueInf05,na.rm=TRUE)*1.1,lwd=0.01,lty=1,col="pink")
  ...
  # other suggestion Fabrice 08/07/22
  circos.segments(sector.index=4,x0=53257785,y0=0,x1=53257785,y1=max(dataset$PropSNPWinPvalueInf05),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=3,x0=46602666,y0=0,x1=46602666,y1=max(dataset$PropSNPWinPvalueInf05),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=6,x0=44936940,y0=0,x1=44936940,y1=max(dataset$PropSNPWinPvalueInf05),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=1,x0=60629756,y0=0,x1=60629756,y1=max(dataset$PropSNPWinPvalueInf05),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=7,x0=1119812,y0=0,x1=1119812,y1=max(dataset$PropSNPWinPvalueInf05),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=5,x0=36547517,y0=0,x1=36547517,y1=max(dataset$PropSNPWinPvalueInf05),lwd=0.3,lty=1,col="forestgreen")
  ...
  #
  # roQSN region
  circos.rect(sector.index=3,xleft=28500000,ybottom=max(dataset$PropSNPWinPvalueInf01,na.rm=TRUE)*-0.1,xright=33000000,ytop=max(dataset$PropSNPWinPvalueInf01,na.rm=TRUE)*1.1,lwd=0.01,lty=1,col="pink")
  ...
  # other suggestion Fabrice 08/07/22
  circos.segments(sector.index=4,x0=53257785,y0=0,x1=53257785,y1=max(dataset$PropSNPWinPvalueInf01),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=3,x0=46602666,y0=0,x1=46602666,y1=max(dataset$PropSNPWinPvalueInf01),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=6,x0=44936940,y0=0,x1=44936940,y1=max(dataset$PropSNPWinPvalueInf01),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=1,x0=60629756,y0=0,x1=60629756,y1=max(dataset$PropSNPWinPvalueInf01),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=7,x0=1119812,y0=0,x1=1119812,y1=max(dataset$PropSNPWinPvalueInf01),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=5,x0=36547517,y0=0,x1=36547517,y1=max(dataset$PropSNPWinPvalueInf01),lwd=0.3,lty=1,col="forestgreen")
  ...
  # roQSN region
  circos.rect(sector.index=3,xleft=28500000,ybottom=max(dataset$PropSNPWinPvalueInf001,na.rm=TRUE)*-0.1,xright=33000000,ytop=max(dataset$PropSNPWinPvalueInf001,na.rm=TRUE)*1.1,lwd=0.01,lty=1,col="pink")
  ...
  # other suggestion Fabrice 08/07/22
  circos.segments(sector.index=4,x0=53257785,y0=0,x1=53257785,y1=max(dataset$PropSNPWinPvalueInf001),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=3,x0=46602666,y0=0,x1=46602666,y1=max(dataset$PropSNPWinPvalueInf001),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=6,x0=44936940,y0=0,x1=44936940,y1=max(dataset$PropSNPWinPvalueInf001),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=1,x0=60629756,y0=0,x1=60629756,y1=max(dataset$PropSNPWinPvalueInf001),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=7,x0=1119812,y0=0,x1=1119812,y1=max(dataset$PropSNPWinPvalueInf001),lwd=0.3,lty=1,col="forestgreen")
  circos.segments(sector.index=5,x0=36547517,y0=0,x1=36547517,y1=max(dataset$PropSNPWinPvalueInf001),lwd=0.3,lty=1,col="forestgreen")
