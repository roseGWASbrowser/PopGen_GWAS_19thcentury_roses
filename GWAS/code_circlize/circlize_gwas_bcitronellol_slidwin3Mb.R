...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/bcitronellol_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/bcitronellol_gwas_results")
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/bcitronellol_gwas_results")
gwasres=read.table("bcitronellol_scores.txt.withoutchrNA.sed",h=T)
trait="bcitronellol"
#label_legend="GWAS b-citronellol (2017)"
#label_legend="GWAS b-citronellol (2018)"
label_legend="GWAS b-citronellol (All)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/bcitronellol_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/bcitronellol_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/bcitronellol_binary0p1_gwas_results")
#gwasres=read.table("bcitronellol_binary0p1_scores.txt.withoutchrNA.sed",h=T)
#trait="bcitronellol_binary0p1"
#label_legend="GWAS b-citronellol (binary 2017 - cutoff: 0.1)"
#label_legend="GWAS b-citronellol (binary 2018 - cutoff: 0.1)"
#label_legend="GWAS b-citronellol (binary All - cutoff: 0.1)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/bcitronellol_binary15_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/bcitronellol_binary15_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/bcitronellol_binary15_gwas_results")
#gwasres=read.table("bcitronellol_binary15_scores.txt.withoutchrNA.sed",h=T)
#trait="bcitronellol_binary15"
#label_legend="GWAS b-citronellol (binary 2017 - cutoff: 15)"
#label_legend="GWAS b-citronellol (binary 2018 - cutoff: 15)"
#label_legend="GWAS b-citronellol (binary All - cutoff: 15)"
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # QTL 95%
  # 2014
  circos.rect(sector.index=2,xleft=1513396,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=38563162,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # lightcoral = 2017
  circos.rect(sector.index=5,xleft=21900974,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=75478763,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=6,xleft=222596,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=22455818,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=7,xleft=25872511,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=65181365,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  
  # 2015
  circos.rect(sector.index=2,xleft=238892,ybottom=max(dataset$Prop_Win_Total)*1.51,xright=38563162,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=4,xleft=19132510,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=35967231,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=6,xleft=222596,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=42726381,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=2,xleft=956943,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=74948359,ytop=max(dataset$Prop_Win_Total)*1.5,lwd=0.01,lty=1,col="#C46500") #  = 2019
  ...
  # 2017
  circos.rect(sector.index=2,xleft=7264334,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=38563162,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=4,xleft=19132510,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=58643863,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=5,xleft=23393673,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=76386903,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=6,xleft=222596,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=10729472,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  ...
  # NUDIX1-1a region ?
  circos.rect(sector.index=2,xleft=55708792,ybottom=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*-0.1,xright=58827470,ytop=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*1.1,lwd=0.01,lty=1,col="pink")
  circos.text(sector.index=2, 57000000, max(-log10(gwasres[[columntoplot]]),na.rm=TRUE), "NUDIX1-1a region",cex=0.75,col="purple")
