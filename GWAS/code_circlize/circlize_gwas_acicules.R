...
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/phenoflorhige/Nb_acicules_branch_gwas_results/")
gwasres=read.table("Nb_acicules_branch_scores.txt.withoutchrNA.sed",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
trait="Nb_acicules_branch"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/phenoflorhige/Nb_acicules_branch_binaryTatiana_gwas_results/")
#gwasres=read.table("Nb_acicules_branch_binaryTatiana_scores.txt.withoutchrNA.sed",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
#trait="Nb_acicules_branch_binaryTatiana"
