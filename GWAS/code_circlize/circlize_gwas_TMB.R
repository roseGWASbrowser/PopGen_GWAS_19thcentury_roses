...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/TMB_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/TMB_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/TMB_gwas_results")
#gwasres=read.table("TMB_scores.txt.withoutchrNA.sed",h=T)
#trait="TMB"
#label_legend="GWAS TMB (2017)"
#label_legend="GWAS TMB (2018)"
#label_legend="GWAS TMB (2 years)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/TMB_binaryPresAbs_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/TMB_binaryPresAbs_gwas_results")
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/TMB_binaryPresAbs_gwas_results")
gwasres=read.table("TMB_binaryPresAbs_scores.txt.withoutchrNA.sed",h=T)
trait="TMB_binaryPresAbs"
#label_legend="GWAS TMB (binary 2017 - cutoff: 0)"
#label_legend="GWAS TMB (binary 2018 - cutoff: 0)"
label_legend="GWAS TMB (binary 2 years - cutoff: 0)"
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # QTL 95%
  # 2014
  circos.rect(sector.index=1,xleft=8070468,ybottom=max(dataset$Prop_Win_Total)*1.71,xright=30449210,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # lightcoral = 2017
  circos.rect(sector.index=1,xleft=10625419,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=64360013,ytop=max(dataset$Prop_Win_Total)*1.7,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=2,xleft=5336759,ybottom=max(dataset$Prop_Win_Total)*1.71,xright=38563162,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=2,xleft=155702,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=74948359,ytop=max(dataset$Prop_Win_Total)*1.7,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=3,xleft=18708317,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=22811266,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=3,xleft=222596,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=42317122,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=4,xleft=19132510,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=51595176,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=5,xleft=137964,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=3660136,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=6,xleft=1518964,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=59282302,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=7,xleft=28966373,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=54347018,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  
  # 2015
  circos.rect(sector.index=1,xleft=452535,ybottom=max(dataset$Prop_Win_Total)*1.51,xright=33163492,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=1,xleft=448505,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=64360013,ytop=max(dataset$Prop_Win_Total)*1.5,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=2,xleft=8953563,ybottom=max(dataset$Prop_Win_Total)*1.51,xright=38563162,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=2,xleft=155702,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=74948359,ytop=max(dataset$Prop_Win_Total)*1.5,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=4,xleft=51595176,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=52321677,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=4,xleft=1013129,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=58329595,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=5,xleft=132913,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=83806257,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=6,xleft=8981494,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=65745018,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=7,xleft=132729,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=66758768,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  
  # 2017
  circos.rect(sector.index=1,xleft=452535,ybottom=max(dataset$Prop_Win_Total)*1.31,xright=62612495,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=1,xleft=22412932,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=64360013,ytop=max(dataset$Prop_Win_Total)*1.3,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=2,xleft=943336,ybottom=max(dataset$Prop_Win_Total)*1.31,xright=38563162,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=2,xleft=720829,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=74948359,ytop=max(dataset$Prop_Win_Total)*1.3,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=3,xleft=19970001,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=46474274,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=4,xleft=858417,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=58329595,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=5,xleft=137964,ybottom=max(dataset$Prop_Win_Total)*1.31,xright=85719826,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=5,xleft=132913,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=83806257,ytop=max(dataset$Prop_Win_Total)*1.3,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=6,xleft=1089751,ybottom=max(dataset$Prop_Win_Total)*1.31,xright=65745018,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=6,xleft=1518964,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=59282302,ytop=max(dataset$Prop_Win_Total)*1.3,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=7,xleft=277485,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=65181365,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  ...
  # POMT: RC6G0495200
  #circos.segments(sector.index=6,x0=59261891,y0=0,x1=59261891,y1=max(dataset$Prop_Win_Total)*0.8,lwd=2,lty=1,col="purple")  
  ...
  # POMT: RC6G0495200
  #circos.segments(sector.index=6,x0=59261891,y0=0,x1=59261891,y1=max(-log10(gwasres[[columntoplot]]),na.rm=TRUE)*0.8,lwd=2,lty=1,col="purple") 
  
  #circos.text(sector.index=2, 41000000, max(-log10(gwasres[[columntoplot]]),na.rm=TRUE), labels="OOMT2 & OOMT1",cex=0.75,col="purple")
  #circos.text(sector.index=6, 59261891, max(-log10(gwasres[[columntoplot]]),na.rm=TRUE), labels="POMT",cex=0.75,col="purple")  
  # values
  ...
  # POMT: RC6G0495200
  #circos.segments(sector.index=6,x0=59261891,y0=0,x1=59261891,y1=max(dataset$PropSNPWinPvalueInf05),lwd=2,lty=1,col="purple") 
  ...
  # POMT: RC6G0495200
  #circos.segments(sector.index=6,x0=59261891,y0=0,x1=59261891,y1=max(dataset$PropSNPWinPvalueInf01),lwd=2,lty=1,col="purple") 
  ...
  # POMT: RC6G0495200
  #circos.segments(sector.index=6,x0=59261891,y0=0,x1=59261891,y1=max(dataset$PropSNPWinPvalueInf001),lwd=2,lty=1,col="purple") 
