...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/Ebfarnesene_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/Ebfarnesene_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/Ebfarnesene_gwas_results")
#gwasres=read.table("Ebfarnesene_scores.txt.withoutchrNA.sed",h=T)
#trait="Ebfarnesene"
#label_legend="GWAS Ebfarnesene (2017)"
#label_legend="GWAS Ebfarnesene (2018)"
#label_legend="GWAS Ebfarnesene (2 years)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/Ebfarnesene_binaryPresAbs_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/Ebfarnesene_binaryPresAbs_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/Ebfarnesene_binaryPresAbs_gwas_results")
#gwasres=read.table("Ebfarnesene_binaryPresAbs_scores.txt.withoutchrNA.sed",h=T)
#trait="Ebfarnesene_binaryPresAbs"
#label_legend="GWAS Ebfarnesene (binary 2017 - cutoff: 0)"
#label_legend="GWAS Ebfarnesene (binary 2018 - cutoff: 0)"
#label_legend="GWAS Ebfarnesene (binary 2 years - cutoff: 0)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/Ebfarnesene_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/Ebfarnesene_binary0p1_gwas_results")
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/Ebfarnesene_binary0p1_gwas_results")
gwasres=read.table("Ebfarnesene_binary0p1_scores.txt.withoutchrNA.sed",h=T)
trait="Ebfarnesene_binary0p1"
#label_legend="GWAS Ebfarnesenel (binary 2017 - cutoff: 0.1)"
#label_legend="GWAS Ebfarnesene (binary 2018 - cutoff: 0.1)"
label_legend="GWAS Ebfarnesene (binary 2 years - cutoff: 0.1)"
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # QTL 95%
  # 2014
  circos.rect(sector.index=3,xleft=18708317,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=34607514,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # lightcoral = 2017
  circos.rect(sector.index=6,xleft=1518964,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=45439985,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=7,xleft=9346983,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=33102847,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  
  # 2015
  circos.rect(sector.index=1,xleft=33163492,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=51406640,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=3,xleft=22606994,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=35001322,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=6,xleft=1518964,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=59282302,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=7,xleft=11935305,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=49951662,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  
  # 2017
  circos.rect(sector.index=1,xleft=452535,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=33163492,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=5,xleft=137964,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=71565216,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=6,xleft=1626959,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=59282302,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=7,xleft=32350617,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=54710222,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
