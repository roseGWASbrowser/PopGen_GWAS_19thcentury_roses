...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/Sum_farnesolfarnesalfarnesylacetate_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/Sum_farnesolfarnesalfarnesylacetate_gwas_results")
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/Sum_farnesolfarnesalfarnesylacetate_gwas_results")
gwasres=read.table("Sum_farnesolfarnesalfarnesylacetate_scores.txt.withoutchrNA.sed",h=T)
trait="Sum_farnesolfarnesalfarnesylacetate"
#label_legend="GWAS Sesquiterpene Alcohol (2017)"
#label_legend="GWAS Sesquiterpene Alcohol (2018)"
label_legend="GWAS Sesquiterpene Alcohol (2 years)"
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # QTL 95%
  # 2014
  circos.rect(sector.index=1,xleft=452535,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=51590106,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # farnesol, farnesal, farnesylacetate
  circos.rect(sector.index=2,xleft=6947297,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=49768903,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # farnesylacetate
  circos.rect(sector.index=3,xleft=18708317,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=42602509,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # farnesol, farneal, farnesylacetate
  circos.rect(sector.index=4,xleft=55803663,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=58329595,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  farnesol, farnesal
  circos.rect(sector.index=7,xleft=8801471,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=54710222,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  fanresol, farnesal
  
  # 2015
  circos.rect(sector.index=1,xleft=452535,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=33163492,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # farnesylacetate
  circos.rect(sector.index=1,xleft=33163492,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=51406640,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # farnesol, farnesal
  circos.rect(sector.index=2,xleft=6947297,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=18453923,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # farnesylacetate
  circos.rect(sector.index=3,xleft=34874101,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=42602509,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # farnesylacetate
  circos.rect(sector.index=4,xleft=19132510,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=58643863,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  farnesal
  circos.rect(sector.index=5,xleft=137964,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=68715373,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  farnesol, farnesal
  circos.rect(sector.index=7,xleft=4722419,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=18944562,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  farnesol
  circos.rect(sector.index=7,xleft=26312896,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=54836131,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  farnesal
  
  # 2017
  circos.rect(sector.index=1,xleft=452535,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=58038560,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  farnesal, farnesylacetate
  circos.rect(sector.index=2,xleft=7094353,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=45140069,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  farnesylacetate
  circos.rect(sector.index=3,xleft=18708317,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=46474274,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  farnesylacetate
  circos.rect(sector.index=4,xleft=712806,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=44188764,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  farnesol
  circos.rect(sector.index=5,xleft=172745,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=85719826,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # farnesol, farnesal
  circos.rect(sector.index=7,xleft=4722419,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=43538814,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  farnesol,farnesal
  ...
  for (line in 1:nrow(gene)){
    circos.segments(sector.index=as.character(gene$V4[line]),x0=gene$V8[line],y0=0,x1=gene$V8[line],y1=max(dataset$PropSNPWinPvalueInf01,na.rm=TRUE),col=ifelse(gene$V1[line]=="NUDX","purple","lightcyan2"),lwd=ifelse(gene$V1[line]=="NUDX",2,1))
  }
 ...
 dev.off() 
 print(paste("finished: ",label_legend))
}
