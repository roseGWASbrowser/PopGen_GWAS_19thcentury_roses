...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/germacreneD_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/germacreneD_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/germacreneD_gwas_results")
#gwasres=read.table("germacreneD_scores.txt.withoutchrNA.sed",h=T)
#trait="germacreneD"
#label_legend="GWAS germacreneD (2017)"
#label_legend="GWAS germacreneD (2018)"
#label_legend="GWAS germacreneD (All)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/germacreneD_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/germacreneD_binary0p1_gwas_results")
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/germacreneD_binary0p1_gwas_results")
gwasres=read.table("germacreneD_binary0p1_scores.txt.withoutchrNA.sed",h=T)
trait="germacreneD_binary0p1"
#label_legend="GWAS germacreneD (binary 2017 - cutoff: 0.1)"
#label_legend="GWAS germacreneD (binary 2018 - cutoff: 0.1)"
label_legend="GWAS germacreneD (binary All - cutoff: 0.1)"
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # QTL 95%
  # 2014
  circos.rect(sector.index=2,xleft=8953563,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=29204278,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # lightcoral = 2017
  circos.rect(sector.index=4,xleft=45466960,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=58643863,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=5,xleft=30143922,ybottom=max(dataset$Prop_Win_Total)*1.71,xright=36433343,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=1,xleft=10625419,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=64122942,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=5,xleft=4536435,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=71103861,ytop=max(dataset$Prop_Win_Total)*1.7,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  
  # 2015
  circos.rect(sector.index=3,xleft=18708317,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=44802324,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=5,xleft=18654964,ybottom=max(dataset$Prop_Win_Total)*1.51,xright=26020132,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=6,xleft=10729472,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=59225259,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=1,xleft=448505,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=64360013,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=5,xleft=876757,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=71103861,ytop=max(dataset$Prop_Win_Total)*1.5,lwd=0.01,lty=1,col="#C46500") #  = 2019
  
  # 2017
  circos.rect(sector.index=3,xleft=22871407,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=34607514,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # 
  circos.rect(sector.index=4,xleft=39209552,ybottom=max(dataset$Prop_Win_Total)*1.31,xright=58643863,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #
  circos.rect(sector.index=5,xleft=17654964,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=19705724,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = Here 95% QTL very narrow, I add 1 Mb from each side: true positions 18654964 - 18705724
  circos.rect(sector.index=1,xleft=10625419,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=64122942,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  
  circos.rect(sector.index=2,xleft=155702,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=74948359,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  
  circos.rect(sector.index=4,xleft=712806,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=58329595,ytop=max(dataset$Prop_Win_Total)*1.3,lwd=0.01,lty=1,col="#FFA500") # 
