...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/Sum_geraniolgeranialgeranylacetatecitronellolnerol_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/Sum_geraniolgeranialgeranylacetatecitronellolnerol_gwas_results")
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/Sum_geraniolgeranialgeranylacetatecitronellolnerol_gwas_results")
gwasres=read.table("Sum_geraniolgeranialgeranylacetatecitronellolnerol_scores.txt.withoutchrNA.sed",h=T)
trait="Sum_geraniolgeranialgeranylacetatecitronellolnerol"
#label_legend="GWAS Monoterpene Alcohol (2017)"
#label_legend="GWAS Monoterpene Alcohol (2018)"
label_legend="GWAS Monoterpene Alcohol (2 years)"
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # QTL 95%
  # 2014  # used as a union of all coordinates, so it generates larger regions
  circos.rect(sector.index=2,xleft=155702,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=47013288,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  # geraniol, geranial,geranylacetate
  circos.rect(sector.index=3,xleft=18708317,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=46474274,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  # geranial, nerol
  circos.rect(sector.index=4,xleft=19132510,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=58643863,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  geraniol, geranial,geranylacetate
  circos.rect(sector.index=5,xleft=132913,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=83806257,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # geraniol, geranial, betacitronellol, nerol
  circos.rect(sector.index=6,xleft=222596,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=65745018,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  betacitronellol, nerol
  circos.rect(sector.index=7,xleft=25872511,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=65181365,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  betacitronellol

  # 2015
  circos.rect(sector.index=1,xleft=14426653,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=33163492,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # geranylacetate
  circos.rect(sector.index=2,xleft=155702,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=74948359,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # geraniol, geranial, geranylacetaten, betacitronelol, nerol
  circos.rect(sector.index=3,xleft=36517128,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=44459262,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # geranial
  circos.rect(sector.index=4,xleft=13281656,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=35967231,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # geraniol, geranial, betacitronellol
  circos.rect(sector.index=5,xleft=132913,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=83806257,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # geraniol, geranial, betacitronellol
  circos.rect(sector.index=6,xleft=222596,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=42726381,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # betacitronellol
  circos.rect(sector.index=7,xleft=3540683,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=65453976,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # nerol
  
  # 2017
  circos.rect(sector.index=1,xleft=452535,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=58038560,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # geranylacetate
  circos.rect(sector.index=2,xleft=1019055,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=47013288,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # geraniol, geranial, betacitronellol
  circos.rect(sector.index=4,xleft=13281656,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=58643863,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # gerniol, geranial, betacitronellol
  circos.rect(sector.index=5,xleft=4536435,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=78289507,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # geraniol, geranial, geranylacetate, betacitronellol, nerol
  circos.rect(sector.index=6,xleft=222596,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=65745018,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  betacitronellol, nerol
  circos.rect(sector.index=7,xleft=315731,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=66758768,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # nerol
