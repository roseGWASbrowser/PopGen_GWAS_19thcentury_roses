...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/dihydrobionol_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/dihydrobionol_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/dihydrobionol_gwas_results")
#gwasres=read.table("dihydrobionol_scores.txt.withoutchrNA.sed",h=T)
#trait="dihydrobionol"
#label_legend="GWAS Dihydrobetaionol (2017)"
#label_legend="GWAS Dihydrobetaionol (2018)"
#label_legend="GWAS Dihydrobetaionol (2 years)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/dihydrobionol_binary10_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/dihydrobionol_binary10_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/dihydrobionol_binary10_gwas_results")
#gwasres=read.table("dihydrobionol_binary10_scores.txt.withoutchrNA.sed",h=T)
#trait="dihydrobionol_binary10"
#label_legend="GWAS Dihydrobetaionol (binary 2017 - cutoff: 10)"
#label_legend="GWAS Dihydrobetaionol (binary 2018 - cutoff: 10)"
#label_legend="GWAS Dihydrobetaionol (binary 2 years - cutoff: 10)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/dihydrobionol_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/dihydrobionol_binary0p1_gwas_results")
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/dihydrobionol_binary0p1_gwas_results")
gwasres=read.table("dihydrobionol_binary0p1_scores.txt.withoutchrNA.sed",h=T)
trait="dihydrobionol_binary0p1"
#label_legend="GWAS Dihydrobetaionol (binary 2017 - cutoff: 0.1)"
#label_legend="GWAS Dihydrobetaionol (binary 2018 - cutoff: 0.1)"
label_legend="GWAS Dihydrobetaionol (binary 2 years - cutoff: 0.1)"
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # QTL 95%
  # 2014
  circos.rect(sector.index=2,xleft=23429927,ybottom=max(dataset$Prop_Win_Total)*1.71,xright=38563162,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # lightcoral = 2017
  circos.rect(sector.index=2,xleft=155702,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=74948359,ytop=max(dataset$Prop_Win_Total)*1.7,lwd=0.01,lty=1,col="#8B2500") # lightcoral = 2017
  circos.rect(sector.index=3,xleft=22995936,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=34607514,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # lightcoral = 2017
  circos.rect(sector.index=4,xleft=19132510,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=46189407,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=5,xleft=3356325,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=85719826,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=7,xleft=1963737,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=43538814,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  
  # 2015
  circos.rect(sector.index=2,xleft=3561364,ybottom=max(dataset$Prop_Win_Total)*1.51,xright=38563162,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=2,xleft=155702,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=18453923,ytop=max(dataset$Prop_Win_Total)*1.5,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=3,xleft=22871407,ybottom=max(dataset$Prop_Win_Total)*1.51,xright=25498798,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") # lightcoral = 2017
  circos.rect(sector.index=3,xleft=572626,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=42317122,ytop=max(dataset$Prop_Win_Total)*1.5,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=4,xleft=19132510,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=52239028,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  ...
  circos.rect(sector.index=6,xleft=1518964,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=8437413,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  ...
  # 2017
  circos.rect(sector.index=1,xleft=10625419,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=64360013,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") # lightcoral = 2017
  circos.rect(sector.index=2,xleft=11753978,ybottom=max(dataset$Prop_Win_Total)*1.31,xright=38563162,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=2,xleft=155702,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=74527841,ytop=max(dataset$Prop_Win_Total)*1.3,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=3,xleft=22995936,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=44459262,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=4,xleft=19132510,ybottom=max(dataset$Prop_Win_Total)*1.31,xright=51985753,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=4,xleft=712806,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=50636882,ytop=max(dataset$Prop_Win_Total)*1.3,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=7,xleft=403371,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=52715896,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
