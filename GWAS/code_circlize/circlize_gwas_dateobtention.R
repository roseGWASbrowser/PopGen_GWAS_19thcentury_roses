...
#gwasres=read.table("./year_obtained_gwas_results/year_obtained_scores.sed.withoutchrNA",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
#trait="year_obtained"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/")
#gwasres=read.table("./year_obtained_Cristiana_gwas_results/year_obtained_Cristiana_scores.sed.withoutchrNA",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
#trait="year_obtained_Cristiana"

# version tronque 12/07/22
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/")
gwasres=read.table("./year_obtained_Cristiana_tronq_gwas_results/year_obtained_Cristiana_tronq_scores.sed.withoutchrNA",h=T) #awk '$2 != "NA" {print $0}' INFILE > OUTFILE
trait="year_obtained_Cristiana_tronq"


year_obtained_Cristiana_tronq_scores.sed.withoutchrNA
