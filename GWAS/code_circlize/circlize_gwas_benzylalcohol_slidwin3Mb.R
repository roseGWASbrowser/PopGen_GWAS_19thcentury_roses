...
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/benzylalcohol_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/benzylalcohol_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/benzylalcohol_gwas_results")
#gwasres=read.table("benzylalcohol_scores.txt.withoutchrNA.sed",h=T)
#trait="benzylalcohol"
#label_legend="GWAS benzylalcohol (2017)"
#label_legend="GWAS benzylalcohol (2018)"
#label_legend="GWAS benzylalcohol (All)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/benzylalcohol_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/benzylalcohol_binary0p1_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/benzylalcohol_binary0p1_gwas_results")
#gwasres=read.table("benzylalcohol_binary0p1_scores.txt.withoutchrNA.sed",h=T)
#trait="benzylalcohol_binary0p1"
#label_legend="GWAS benzylalcohol (binary 2017 - cutoff: 0.1)"
#label_legend="GWAS benzylalcohol (binary 2018 - cutoff: 0.1)"
#label_legend="GWAS benzylalcohol (binary All - cutoff: 0.1)"

#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2017/benzylalcohol_binary5_gwas_results")
#setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scent2018/benzylalcohol_binary5_gwas_results")
setwd("/home/thibaultleroy/Rose/documents_transfert_autreordi/GWAS_204cc/scentAvg2years/benzylalcohol_binary5_gwas_results")
gwasres=read.table("benzylalcohol_binary5_scores.txt.withoutchrNA.sed",h=T)
trait="benzylalcohol_binary5"
#label_legend="GWAS benzylalcohol (binary 2017 - cutoff: 5)"
#label_legend="GWAS benzylalcohol (binary 2018 - cutoff: 5)"
label_legend="GWAS benzylalcohol (binary All - cutoff: 5)"
...
for (model in c("additive","diplo.additive","general","diplo.general","1.dom.alt","1.dom.ref","2.dom.alt","2.dom.ref")){
  ...
  # QTL 95%
  # 2014
  circos.rect(sector.index=4,xleft=19132510,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=58643863,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") # lightcoral = 2017
  circos.rect(sector.index=5,xleft=1159318,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=85719826,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  circos.rect(sector.index=6,xleft=1518964,ybottom=max(dataset$Prop_Win_Total)*1.61,xright=6826159,ytop=max(dataset$Prop_Win_Total)*1.8,lwd=0.01,lty=1,col="#8B2500") #  = 2019
  
  # 2015
  circos.rect(sector.index=5,xleft=36433343,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=85719826,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  circos.rect(sector.index=6,xleft=3024656,ybottom=max(dataset$Prop_Win_Total)*1.41,xright=5410244,ytop=max(dataset$Prop_Win_Total)*1.6,lwd=0.01,lty=1,col="#C46500") #  = 2019
  
  # 2017
  circos.rect(sector.index=4,xleft=49403019,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=58379605,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=5,xleft=36090047,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=71103861,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
  circos.rect(sector.index=6,xleft=3024656,ybottom=max(dataset$Prop_Win_Total)*1.21,xright=5410244,ytop=max(dataset$Prop_Win_Total)*1.4,lwd=0.01,lty=1,col="#FFA500") #  = 2019
